...
SNOW_BASE_URL = SNOW_BASE_URL = "https://championsolutionsgroupdemo2.service-now.com/api/x_328385_restapi/bbi/"
API_METHOD = "GET"
...
@task(queue="devices", max_retries=3)
...
# async mail functions
@task(queue="messages", serializer="pickle", max_retries=3)
...
# close database session for each task
